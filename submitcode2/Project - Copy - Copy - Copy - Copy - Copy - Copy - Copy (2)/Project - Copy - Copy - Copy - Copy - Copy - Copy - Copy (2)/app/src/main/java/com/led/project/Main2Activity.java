...
import hello.example.acer.library.ScArcGauge;

public class Main2Activity extends AppCompatActivity {
    ProgressBar prg;
    Button btnOn,btnOff;
    TextView txtString, sensorView0,dataSensor;
    Handler bluetoothIn;
    String sensor0;
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {                                     //if message is what we want
                    ...
                    if (endOfLineIndex > 0) {                                           // make sure there data before ~
                        String dataInPrint = recDataString.substring(5, endOfLineIndex);    // extract string
